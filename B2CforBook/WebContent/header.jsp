							...
							<li data-toggle="sub-header" data-target="#sub-cart">
								...
								<div id="sub-cart" class="sub-header">
									<div class="cart-header">
										<span>你的购物车空空如也</span>
										<small><a href="cart.html">查看购物车</a></small>
									</div>
									...
									<div class="cart-footer">
										...
										<div class="text-right">
											<a href="cart.jsp" class="btn btn-default btn-round view-cart">购物车</a>
											<a href="checkout.jsp" class="btn btn-default btn-round view-cart">去结算</a>
										</div>
									</div>
								</div>
								<!-- // SHOPPING CART -->
				...
				<div class="main-header">
					...
					<nav id="site-menu" role="navigation">
						<ul class="main-menu  hidden-xs">
							...
							<li>
								<a href="productsList.jsp">新书</a>
							</li>
							<li>
								<a href="productsList.jsp">二手书</a>
							</li>
							<li>
