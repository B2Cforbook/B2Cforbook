					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4 col-md-3">
							<section class="widget widget-text">
								<h5 class="widget-title">悦书</h5>
								<div class="widget-content">
									<p>悦书是在线购书的第一品牌，包括多种新书和二手书，是您购书，品书的不二选择。我们诚挚欢迎您的光临</p>
						...
						<div class="col-xs-12 col-sm-4 col-md-2">
							<section class="widget widget-menu">
								<h5 class="widget-title">了解我们</h5>
								<div class="widget-content">
									<ul class="menu iconed-menu unstyled">
										<li><a href="#"><i class="iconfont-circle-blank menu-icon"></i>人才招聘</a></li>
										<li><a href="#"><i class="iconfont-circle-blank menu-icon"></i>物流信息</a></li>
										<li><a href="#"><i class="iconfont-circle-blank menu-icon"></i>关于我们</a></li>
										<li><a href="#"><i class="iconfont-circle-blank menu-icon"></i>退货政策</a></li>
									</ul>
								</div>
							</section>
						</div>
						...
						<div class="col-xs-12 col-sm-4 col-md-4">
							<section class="widget widget-subscription">
								...
								<div class="widget-content">
									<p>注册成为我们的会员，获得悦书的最新信息！！！</p>
									<form action="#" method="post">
										<div class="input-group">
											<label for="subscription-email" class="placeholder">输入您的邮箱</label>
					...
					<div class="col-xs-12 col-sm-6">
						<div class="footer-links center-xs clearfix">
							<ul class="unstyled">
								...
								<li><a href="#">FAQ</a></li>
								<li><a href="#">与我们合作</a></li>
								<li><a href="#">联系我们</a></li>
							</ul>
						</div>
						<div class="space10"></div>
						<div class="copyright center-xs">
							<p>©2015WEB课程设计||<a href=https://github.com/bysuggestion/B2Cforbook“ target="_blank" title="王幸岚WEB课设">王幸岚</a>  ||All Rights Reserved.</p>
						</div>
					</div>
